...
files="bashrc bash_prompt carbon-now.json config doom.d fzf.zsh gitignore gnupg psqlrc scripts sh_aliases sh_profile tmux.conf vimrc zshrc"    # list of files/folders to symlink in homedir
